...
"i=(1-v.a)*vec4(mix(vec3(0),mix(vec3(.2),vec3(.4,.4,.8),g),f(a*.00001+o*.006))+max(e*e*e*e*e*g,0),1)*(1-z)+v*(1+z),e=min(1,(2-abs(c.g))*smoothstep(-.05,.0,l-.05)*smoothstep(-1.,-.95,-l)),i*=e*e*e;"
"}"
#endif
"";
